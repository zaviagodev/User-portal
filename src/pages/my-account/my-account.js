...
const MyAccount = () => {
    ...
    return (
      <div>
        ...
        <Modal style={{top:"25%",bottom:"25%"}} className="logout-modal text-center" open={logoutModal} onOk={closeModal} onCancel={closeModal} closable={false} cancelText="ยกเลิก" okText="ออกจากระบบ">
