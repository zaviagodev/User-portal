...
import { faChevronLeft, faGift, faGiftCard } from "@fortawesome/pro-solid-svg-icons";
...
const RewardsPage = () => {
    return (
        <div>
            <HeaderMobile firstLink="/" firstIcon={faChevronLeft} title="แลกของรางวัล" secondBtn={true} secondLink="#" secondIcon={faGift} />
            <main>
