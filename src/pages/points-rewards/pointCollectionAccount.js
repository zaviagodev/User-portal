...
const PointCollectionAccount = () => {
    return (
        <div>
            <HeaderMobile firstLink="/my-account" firstIcon={faChevronLeft} title="วิธีเก็บคะแนน" secondBtn={false}/>
            <main className="p-6">
...
export default PointCollectionAccount;