...
const FooterMenu = (props) => {
    return (
      <footer className="px-5 py-3 fixed w-full bg-white bottom-0 z-50" style={{borderTop:"1px solid #F8F8F8"}}>
        <nav>
          <ul className="flex justify-between">
            <li className={`text-sm px-2 ${(props.activeMenu === 1 ? "primary-color" : "menu-inactive-color")}`}>
              <Link to="/">
            ...
            <li className={`text-sm px-2 ${(props.activeMenu === 2 ? "primary-color" : "menu-inactive-color")}`}>
              <Link to="/rewards">
            ...
            <li className={`text-sm px-2 ${(props.activeMenu === 3 ? "primary-color" : "menu-inactive-color")}`}>
              <Link to="/history">
            ...
            <li className={`text-sm px-2 ${(props.activeMenu === 4 ? "primary-color" : "menu-inactive-color")}`}>
              <Link to="#">
